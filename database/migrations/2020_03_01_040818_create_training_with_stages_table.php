...
class CreateTrainingWithStagesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('training_with_state', function (Blueprint $table) {
            $table->bigIncrements('id_training_with_state');
        ...
        Schema::table('training_with_state', function (Blueprint $table) {
